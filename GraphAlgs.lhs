...
> degreeSpectrum g = map countInstances [0..maxSize] 
>  where degreeList = map (degree g) (vertices g)
>        maxSize = length (vertices g) - 1
>        countInstances x = length $ filter (==x) degreeList
